...
body {
				...
				<div class="contact-info">
					<ul>
                                            ...
                                            <br>
                                             ...
                                             <th> FLAT/HOUSE BOOKING DETAILS </th></tr>
                                             </table>
					</ul>
				</div>
				<div class="clear"> </div>
  ...
  <li class="nav-item"><a href="about-us.html"class="dropdown-toggle" data-toggle="dropdown">SEARCH<i class="fa fa-angle-down"></i></a>
          ...
          <li><a href="bookingdetails1.jsp">LAND BOOKING DETAILS</a></li>
           ...
           <li class="nav-item"><a href="buyer_account.jsp">Add Account</a></li>
            <li class="nav-item"><a href="view_buyer_acc.jsp">View Account</a></li>
          <li class="nav-item">
 ...
 <style>
  ...
  <!--/ Carousel Star /-->
		    ...
		    <div class="wrap">
		    	<div class="content">
                            <%
                                        ResultSet ts=db.Select("Select * from bookingss1 where A_Name='"+name+"' ");
                     ...
                     <form name="Check1"  action="Encrypt_Details" method="post" onsubmit="return ValidateDate(true);">
                                        <center>
                                            ...
                                            <br><h4>FLAT/HOUSE DETAILS</h4><br>                                     
                                           <%
                                        while(ts.next())
                                        {
                                            %>
                                            <div class="col-lg-6"> 
                                                ...
                                                <table border="1">
                                                    ...
                                                    <tr>
                                                        <th>SELLER NAME</th><td><%=ts.getString("S_Name")%></td>
                                                    </tr>
                                                    <tr>
                                                        <th>HOUSE NUMBER</th><td><%=ts.getString("H_NO")%></td>
                                                    </tr>
                                                    <tr>
                                                        <th>HOUSE STREET</th><td><%=ts.getString("street")%></td>
                                                    </tr>
                                                    <tr>
                                                        <th>BUYER NAME</th><td><%=ts.getString("U_NAME")%></td>
                                                    </tr>
                                                    <tr>
                                                        <th>BUYER NUMBER</th><td><%=ts.getString("U_NUMBER")%></td>
                                                    </tr>
                                                    <tr>
                                                        <th>BUYER MAIL-ID</th><td><%=ts.getString("U_MAIL")%></td>
                                                    </tr>
                                                    <tr>
                                                        <th>FLAT APPROVAL STS</th><td><%=ts.getString("STS")%></td>
                                                    </tr>                        
                                                    <tr>
                                                        <th>BOOKING FESS</th><td><%=ts.getString("B_fess")%></td>
                                                    </tr>
                                                    <tr>
                                                        <th>ADMIN ACCOUNT NUMBER</th><td><%=ts.getString("A_ACC")%></td>
                                                    </tr>
                                                    <tr>
                                                        <th>CARD TYPE</th><td><%=ts.getString("C_Type")%></td>
                                                    </tr>
                                                    <tr>
                                                        <th>BUYER ACCOUNT NUMBER</th><td><%=ts.getString("U_ACC")%></td>
                                                    </tr>
                                                    <tr>
                                                        <th>AADHAR CARD NO</th><td><%=ts.getString("A_Name")%>></td>
                                                    <br><br>
                                                    <tr>
                                                        <th>DECRYPTION</th>
                                                        
                                                    <td color:black>
                                                <a href="mail?id1=<%=ts.getString("A_Name")%>&id2=<%=ts.getInt("id")%>">View</a>
                                            </td>
                                                    </tr>
                                                </table>  
