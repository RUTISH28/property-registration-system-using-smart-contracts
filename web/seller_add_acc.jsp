...
<aside class="sd-sidebar" id="sidebar">
  ...
  <nav class="sd-nav">
    ...
    <div class="sd-nav-section">
      ...
      <a href="seller_add_acc.jsp" class="active"><i class="fa fa-university"></i> Add Acc</a>
...
<header class="by-topbar">
  ...
  <div class="by-topbar-actions">
    <a href="seller_add_acc.jsp" class="by-btn by-btn-outline by-btn-sm"><i class="fa fa-university"></i> My Accounts</a>
    <a href="sellerhome.jsp" class="by-btn by-btn-outline by-btn-sm"><i class="fa fa-home"></i></a>
  </div>
</header>
...
<div class="by-page">
  ...
  <div class="by-alert by-a-teal by-fade">
    ...
    <span>
      After adding, go to <a href="seller_add_acc.jsp" style="color:var(--primary);font-weight:700">My Accounts</a>
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:1.8rem;align-items:start" class="by-fade">
    ...
    <div class="by-card by-fade">
      ...
      <div class="by-card-body">
        ...
        <form action="seller_account" method="POST" onsubmit="return validateForm()">
          <!-- Hidden fields -->
          <input type="hidden" name="seller_id"    value="<%=U_Id%>">
          <input type="hidden" name="seller_name"  value="<%=sellerName%>">
          <input type="hidden" name="seller_email"  value="<%=email%>">
          <input type="hidden" name="seller_aadhar" value="<%=A_Name%>">
          ...
          <p style="text-align:center;font-size:.70rem;color:var(--text3);margin-top:.8rem">
            ...
            After adding, set as default in <a href="seller_add_acc.jsp" style="color:var(--primary)">My Accounts</a>.
          </p>
        </form>
