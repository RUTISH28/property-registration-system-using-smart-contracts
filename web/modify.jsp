<%-- 
    Document   : modify
    Created on : 30 Jun, 2023, 3:14:39 PM
    Author     : Admin1
--%>
...
<div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
    <center><h3 class="mb-4">BUYER DETAILS</h3></center>
    <div class="table-responsive">
        <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
                <%
                    DB db1 = new DB();
                    String query = "SELECT * FROM booking WHERE STS='Approved'";
                ...
                <tr>
                    ...
                    <td><%= rs.getString("U_MAIL") %></td>
                    <td><%= rs.getString("U_NUMBER") %></td>
                    <td><%= rs.getString("SUNO") %></td>
                    <td><%= rs.getString("D_NO") %></td>
                    <td><span class="badge bg-success"><%= rs.getString("STS") %></span></td>
                    <td>
                        <a href="request6.jsp?A_NAME=<%= rs.getString("A_NAME") %>" class="btn btn-warning btn-sm">
                            SOLD OUT
                        </a>
                    </td>
                    <td>
                        <a href="request9.jsp?S_ID=<%= rs.getString("S_ID") %>" class="btn btn-warning btn-sm">
                            SOLD OUT
                        </a>
                    </td>
                </tr>
