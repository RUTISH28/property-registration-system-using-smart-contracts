<%-- 
    Document   : User_searchfile1
    Created on : 30 Jun, 2023, 2:19:14 PM
    Author     : Admin1
--%>
...
<html lang="en-gb" class="no-js">
        ...
        <%
					...
					<ul>
                                            ...
                                            <br>
                                             ...
                                             <th>USER NAME :<td><%=rs.getString("username")%></td></th>
                                             <th> FLAT/HOUSE SEARCH  </th></tr>
                                             </table>
					</ul>
				</div>
 ...
 <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
          ...
          <li class="nav-item">
            ...
            <div class="container">
                ...
                <div class="content_fullwidth">
                    ...
                    <center>
                        <br>
                        <form method="post" action="User_searchfile1.jsp" onsubmit="return frmvalia();">   
    ...
    <%
                ...
                String sql="select * from flat_house where sts='Approved' and  area regexp ('" + STerm + "')";
