<%-- 
    Document   : charges
    Created on : May 12, 2023, 10:52:42 AM
    Author     : elangovan
--%>
                        ...
                        <table class="table table-bordered text-center">
                            <tbody>
                                <%
                                    ...
                                    ResultSet rs1 = db1.Select("SELECT * FROM upload WHERE S_ID='" + id + "'");
                                    while (rs1.next()) {
                                %>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><input type="text" name="fess" id="fess" class="form-control" value="<%= rs1.getString("fess") %>" required></td>
                                </tr>
                                <%
                                    }
                                %>
