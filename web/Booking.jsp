       ...
       <div class="collapse navbar-collapse navbar-right" style="">
		...
		<div class="clear"> </div>
		    ...
		    <div class="wrap">
              ...
              <form action="BOOKING" method="post" onsubmit="return Validate1(true);" name="form">
                            <%
                                        String hh=request.getParameter("B_id");
                                        session.setAttribute("B_id", hh);
                                        int B_id=Integer.parseInt(hh);
                                        ResultSet ts=db.Select("Select * from upload where S_ID='"+B_id+"' ");
                                        
                                        %>		
						 <div class="clear">
                                        <center>
                                            <br><h4>SELLER DETAILS</h4><br>
                                                                           
                                           <%
                                        while(ts.next())
                                        {
                                            %>
                             <input type="hidden" name="SA_Name" value="<%=ts.getString("A_Name")%>"  readonly />                  
                ...
                <span class="heading" style="color: silver">LAND AREA</span><br></br>
                <input type="text" name="area" value="<%=ts.getString("area")%>" id="area" size="35" readonly /><input type="checkbox" name="cb" id="cb" value="5"><br><br>
                 
                <span class="heading" style="color: silver">DOCUMENT NUMBER </span><br></br>
                <input type="text" name="D_NO" value="<%=ts.getString("D_NO")%>" id="D_NO" size="35" readonly /><input type="checkbox" name="cb" id="cb" value="6"><br><br>
                
                <span class="heading" style="color: silver">SURVEY NUMBER </span><br></br>
                <input type="text" name="SUNO" value="<%=ts.getString("SUNO")%>" id="SUNO" size="35" readonly /><input type="checkbox" name="cb" id="cb" value="7"><br><br>
                
                 <span class="heading" style="color: silver">USER NAME</span><br></br>
                 <input type="text" value="" id="U_NAME" name="U_NAME" size="35" required /><br><br>
      
                   <span class="heading" style="color: silver">USER NUMBER</span><br></br>
                   <input type="text" value="" id="U_NUMBER" name="U_NUMBER" size="35" required /><input type="checkbox" name="cb" id="cb" value="9"><br><br>
                  
                   <span class="heading" style="color: silver">USER MAIL ID</span><br></br>
                   <input type="text" value="" id="U_MAIL" name="U_MAIL" size="35" required /><input type="checkbox" name="cb" id="cb" value="10"><br><br>
                ...
                <input type="text" name="S_MAIL" value="<%=ts.getString("S_MAIL")%>" id="S_MAIL" size="35" hidden="">
                                   ...
                                   %>
                                        ...
                                        while(ts1.next())
                                        {
                                          ...
                                          </select><input type="checkbox" name="cb" id="cb" value="12">
                                                  </td>
                                              </tr>
                                               <tr>
                                                  <td>USER ACCOUNT NUMBER</td>
                                                  <td><input type="text" name="U_ACC" value="" id="U_ACC" ><input type="checkbox" name="cb" id="cb" value="13"></td>
                                              </tr>
