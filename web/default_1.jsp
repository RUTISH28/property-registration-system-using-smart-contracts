...
<!DOCTYPE html>
    ...
    if (buyer_id != null && accid != null && !accid.isEmpty()) {
        Connection con = null;
        ...
        try {
            ...
            String query = "UPDATE buyer_account SET status='NO' WHERE buyer_id=?";
            ps = con.prepareStatement(query);
            ps.setInt(1, buyer_id);
            ps.executeUpdate();

            // 2️⃣ Set selected account to YES
            String query1 = "UPDATE buyer_account SET status='YES' WHERE buyer_acc_id=?";
