     ...
     */
     protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DB db1=new DB();
        System.out.println("insert into bookingss(S_ID, S_NAME, S_MAIL, street, H_NO, U_NAME, U_NUMBER, U_MAIL, STS, A_ACC, C_Type, U_ACC, B_fess, key, id,A_NAME,SA_NAME) values('" + S_ID + "','" + S_NAME + "','" + S_MAIL + "','" + street + "','" + H_NO + "','" + U_NAME + "','" + U_NUMBER + "','" + U_MAIL + "','" + STS + "','" + A_ACC + "','" + C_Type + "','" + U_ACC + "','" + B_fess + "','" + key + "','" + A_NAME + "','" + SA_NAME + "')");
            int i = db1.Insert("insert into bookingss(S_ID, S_NAME, S_MAIL, street, H_NO, U_NAME, U_NUMBER, U_MAIL, STS, A_ACC, C_Type, U_ACC, B_fess, key1,A_NAME,SA_NAME) values('" + S_ID + "','" + S_NAME + "','" + S_MAIL + "','" + street + "','" + H_NO + "','" + U_NAME + "','" + U_NUMBER + "','" + U_MAIL + "','" + STS + "','" + A_ACC + "','" + C_Type + "','" + U_ACC + "','" + B_fess + "','" + key + "','" + A_NAME + "','" + SA_NAME + "')");
           ...
           if (i > 0) {
            ...
            String query1 = "insert into bookingss1(S_ID, S_NAME, S_MAIL, street, H_NO, U_NAME, U_NUMBER, U_MAIL, STS, A_ACC, C_Type, U_ACC, B_fess, key1,A_NAME,SA_NAME) values('" + S_ID + "','" + S_NAME + "','" + S_MAIL + "','" + street + "','" + H_NO + "','" + U_NAME + "','" + U_NUMBER + "','" + U_MAIL + "','" + STS + "','" + A_ACC + "','" + C_Type + "','" + U_ACC + "','" + B_fess + "','" + key + "','"+A_NAME+"','" + SA_NAME + "')";
